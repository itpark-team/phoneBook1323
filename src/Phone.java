public class Phone {
    ...
    public void setModel(String model) throws Exception {
        if (model.length() < 3 || model.length() > 30) {
            throw new Exception("Ошибка установки названия модели телефона. Длина должна быть от 3 до 30 символов");
        }
        this.model = model;
    }
    ...
    public void setPrice(int price) throws Exception {
        if (price <= 0 || price > 1000000) {
            throw new Exception("Ошибка установки цены телефона. Цена должна быть от 1 до 1000000 рублей");
        }
        this.price = price;
    }
